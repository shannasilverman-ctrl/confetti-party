...
export const THEMES: Theme[] = [
  // ---------- BIRTHDAY ----------
  {
    ...
    decorIdeas: [
      { title: "Rainbow balloon arch over the entry", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Iridescent tablecloth on the main table", kind: "Buy", bucket: "1-2 weeks" },
      { title: "DIY unicorn horn headbands for guests", kind: "DIY", bucket: "1-2 weeks" },
      { title: "Cloud-shaped paper napkin rings", kind: "DIY", bucket: "Party week" },
      { title: "Hang pastel streamers as a rainbow backdrop", kind: "DIY", bucket: "Day of" },
      { title: "Star-shaped fairy lights around the dessert table", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Sprinkle rainbow confetti down the table runner", kind: "Buy", bucket: "Day of" },
      { title: "Cotton candy in mini clouds for favors", kind: "Buy", bucket: "Party week" },
      { title: "Unicorn-themed tableware set", kind: "Buy", bucket: "1-2 weeks" },
    ],
    stylingTips: [
  ...
  },
  {
    ...
    decorIdeas: [
      { title: "Kraft paper table runner with dino footprints", kind: "DIY", bucket: "Party week" },
      { title: "Potted ferns and moss down the center", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Dino excavation dig kits as favors", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Cave entrance made from a brown sheet at the door", kind: "DIY", bucket: "Party week" },
      { title: "Toy dinosaurs scattered across the table", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Volcano cupcake tower with red-orange frosting", kind: "DIY", bucket: "Day of" },
      { title: "Green and brown balloon garland", kind: "Buy", bucket: "1-2 weeks" },
  ...
  },
  {
    ...
    decorIdeas: [
      { title: "Comic-book POW / ZAP paper cutouts on the walls", kind: "DIY", bucket: "1-2 weeks" },
      { title: "Red, blue, and yellow balloon column at the door", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Cape and mask kit for each guest", kind: "Buy", bucket: "3-5 weeks" },
      { title: "City skyline silhouette on kraft paper backdrop", kind: "DIY", bucket: "1-2 weeks" },
      { title: "Superhero-logo cookies on the dessert table", kind: "Buy", bucket: "Party week" },
      { title: "'Training academy' obstacle course in the yard", kind: "DIY", bucket: "Day of" },
      { title: "Comic-strip printed table runner", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Phone-booth photo prop by the entry", kind: "DIY", bucket: "1-2 weeks" },
    ],
    stylingTips: [
  ...
  },
  {
    ...
    decorIdeas: [
      { title: "Blue crepe paper 'waves' along the table edge", kind: "DIY", bucket: "Party week" },
      { title: "Mermaid-tail balloon garland", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Shells and starfish scattered as table confetti", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Hanging paper jellyfish above the food table", kind: "DIY", bucket: "1-2 weeks" },
      { title: "Bubble machine near the entry", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Ombre blue drinks with pineapple 'seaweed' garnish", kind: "DIY", bucket: "Day of" },
      { title: "Fishnet draped as a backdrop with paper fish", kind: "DIY", bucket: "1-2 weeks" },
  ...
  },
  {
    ...
    decorIdeas: [
      { title: "Mismatched vintage teacups from the thrift store", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Fresh cut flowers in mason jars", kind: "Buy", bucket: "Party week" },
      { title: "Tiered dessert stands with mini scones", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Lace tablecloth layered over linen", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Handwritten place cards on kraft tags", kind: "DIY", bucket: "Party week" },
      { title: "Floral crown-making station for guests", kind: "DIY", bucket: "1-2 weeks" },
      { title: "String lights woven through nearby branches", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Cucumber and berry infused water in glass pitchers", kind: "DIY", bucket: "Day of" },
    ],
    stylingTips: [
  ...
  },
  {
    ...
    decorIdeas: [
      { title: "Blacklight bulbs in every lamp", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Glow-stick bracelets in a bowl at the door", kind: "Buy", bucket: "1-2 weeks" },
      { title: "White table linens (they glow under UV)", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Neon paint splatter poster backdrop", kind: "DIY", bucket: "1-2 weeks" },
      { title: "Tonic-water drinks (they fluoresce)", kind: "Buy", bucket: "Party week" },
      { title: "Neon duct tape geometric shapes on the walls", kind: "DIY", bucket: "Party week" },
      { title: "White balloons with neon painted stripes", kind: "DIY", bucket: "Day of" },
  ...
  // ---------- BABY SHOWER ----------
  {
    ...
    decorIdeas: [
      { title: "Pampas grass in tall glass vases", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Macramé wall hanging as backdrop", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Linen napkins tied with jute twine", kind: "DIY", bucket: "1-2 weeks" },
      { title: "Terracotta mini pots as favors", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Wooden slice charger plates", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Nude and cream balloon garland", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Rattan pendant lights above the table", kind: "Buy", bucket: "1-2 weeks" },
  ...
  },
  {
    ...
    decorIdeas: [
      { title: "Navy tablecloth with gold star confetti", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Star-shaped fairy lights strung overhead", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Moon-and-stars balloon cluster", kind: "Buy", bucket: "1-2 weeks" },
      { title: "'Twinkle twinkle little star' banner", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Star-cutout sugar cookies as favors", kind: "Buy", bucket: "Party week" },
      { title: "Cloud-shaped cake with gold star topper", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Gold-dipped taper candles", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Constellation printable place cards", kind: "DIY", bucket: "Party week" },
    ],
    stylingTips: [
  ...
  },
  {
    ...
    decorIdeas: [
      { title: "Animal-print paper napkins", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Plush safari animals as centerpieces", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Fringe tablecloth in golden tan", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Palm leaves down the table runner", kind: "Buy", bucket: "Party week" },
      { title: "'Wild One' banner over the cake", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Zebra-striped straws in drinks", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Terracotta and orange balloon arch", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Safari cracker treat bags for favors", kind: "DIY", bucket: "Party week" },
    ],
    stylingTips: [
  ...
  },
  {
    ...
    decorIdeas: [
      { title: "Bud vases in a line down the table", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Pastel balloon cloud in the corner", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Petal-scattered white table runner", kind: "DIY", bucket: "Day of" },
      { title: "Watercolor-printed menu cards", kind: "DIY", bucket: "Party week" },
      { title: "Flower-shaped shortbread cookies", kind: "Buy", bucket: "Party week" },
      { title: "Blush ribbon backdrop", kind: "DIY", bucket: "1-2 weeks" },
      { title: "Small potted succulents as favors", kind: "Buy", bucket: "3-5 weeks" },
  ...
  // ---------- GRADUATION ----------
  {
    ...
    occasion: "graduation",
    name: "Gold and Glory",
    vibe: "Black tie meets confetti — deep black, champagne, and metallic gold.",
    ...
    decorIdeas: [
      { title: "Black tablecloth with gold sequin runner", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Champagne flute display for a toast", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Gold graduation cap balloons", kind: "Buy", bucket: "1-2 weeks" },
      { title: "'Class of' foil banner over the mantel", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Photo wall of grad from K through 12", kind: "DIY", bucket: "1-2 weeks" },
      { title: "Gold-foil edged plates", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Diploma-shaped cookies as favors", kind: "Buy", bucket: "Party week" },
  ...
  },
  {
    ...
    decorIdeas: [
      { title: "Papel picado banners strung across the yard", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Cactus centerpieces in terracotta pots", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Colorful woven blanket as tablecloth", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Margarita bar with fresh limes on display", kind: "DIY", bucket: "Day of" },
      { title: "Marigold blooms scattered along the runner", kind: "Buy", bucket: "Party week" },
      { title: "String lights zig-zagged overhead", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Serape-striped napkins", kind: "Buy", bucket: "1-2 weeks" },
  ...
  },
  {
    ...
    decorIdeas: [
      { title: "Blown-up yearbook photos on the wall", kind: "DIY", bucket: "1-2 weeks" },
      { title: "Vintage lockers or trophies as props", kind: "DIY", bucket: "3-5 weeks" },
      { title: "Cream and cherry-red balloon garland", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Notebook-paper printed table runner", kind: "DIY", bucket: "1-2 weeks" },
      { title: "'Sign my yearbook' guest book on the entry table", kind: "DIY", bucket: "1-2 weeks" },
      { title: "'90s hits playlist on a boombox prop", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Cassette-tape shaped cookies", kind: "Buy", bucket: "Party week" },
  ...
  // ---------- HOLIDAY ----------
  {
    ...
    decorIdeas: [
      { title: "White faux fur table runner", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Crystal ornaments as place-setting accents", kind: "Buy", bucket: "1-2 weeks" },
      { title: "White paper snowflakes hanging from the ceiling", kind: "DIY", bucket: "1-2 weeks" },
      { title: "Bare branches spray-painted white in tall vases", kind: "DIY", bucket: "3-5 weeks" },
      { title: "Silver taper candles down the center", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Snowflake-etched drinking glasses", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Icy blue string lights along the mantel", kind: "Buy", bucket: "1-2 weeks" },
  ...
  },
  {
    ...
    decorIdeas: [
      { title: "Red-and-black buffalo plaid tablecloth", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Pinecones and evergreen sprigs along the runner", kind: "DIY", bucket: "Party week" },
      { title: "Fireplace with real crackling wood", kind: "DIY", bucket: "Day of" },
      { title: "Hot cocoa bar with marshmallows and syrups", kind: "DIY", bucket: "Day of" },
      { title: "Wool blankets draped over every chair", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Lanterns with pillar candles on the porch", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Wood-slice charger plates", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Cinnamon-stick bundle napkin ties", kind: "DIY", bucket: "Party week" },
    ],
    stylingTips: [
  ...
  },
  {
    ...
    decorIdeas: [
      { title: "Gold sequin table runner", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Small disco balls as centerpieces", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Champagne tower on the sideboard", kind: "DIY", bucket: "Day of" },
      { title: "Gold-tipped taper candles", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Blush balloon and gold star garland", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Metallic gold cocktail napkins", kind: "Buy", bucket: "1-2 weeks" },
      { title: "'Cheers' foil banner over the bar", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Fringe curtain backdrop in gold Mylar", kind: "Buy", bucket: "3-5 weeks" },
    ],
    stylingTips: [
  ...
  // ---------- DINNER PARTY ----------
  {
    ...
    name: "Tuscan Table",
    vibe: "Sun-baked terracotta, olive, and cream — rustic Italian warmth.",
    ...
    decorIdeas: [
      { title: "Terracotta serving platters family-style", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Olive branches down the runner", kind: "Buy", bucket: "Party week" },
      { title: "Linen tablecloth in unbleached cream", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Chianti bottles as candlesticks", kind: "DIY", bucket: "3-5 weeks" },
      { title: "Rustic bread board with focaccia at the center", kind: "DIY", bucket: "Day of" },
      { title: "Handwritten menu cards on kraft paper", kind: "DIY", bucket: "Party week" },
      { title: "Fresh rosemary sprigs at each place setting", kind: "DIY", bucket: "Day of" },
  ...
  },
  {
    ...
    vibe: "Moody minimal — black, brass, and deep burgundy in candlelight.",
    ...
    decorIdeas: [
      { title: "Black linen tablecloth", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Brass taper candlesticks at varied heights", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Deep burgundy taper candles", kind: "Buy", bucket: "1-2 weeks" },
      { title: "Single-stem dark florals in small vessels", kind: "Buy", bucket: "Party week" },
      { title: "Matte black stoneware plates", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Linen napkins tied with brass rings", kind: "DIY", bucket: "1-2 weeks" },
      { title: "Dim the overheads to 20% — candles do the work", kind: "DIY", bucket: "Day of" },
  ...
  },
  {
    ...
    occasion: "dinner-party",
    name: "Garden Bistro",
    vibe: "French bistro outdoors — white linen, green foliage, warm string lights.",
    ...
    decorIdeas: [
      { title: "Crisp white tablecloth over the table", kind: "Buy", bucket: "1-2 weeks" },
      { title: "String lights zig-zagged overhead", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Bistro-style café chairs", kind: "Buy", bucket: "3-5 weeks" },
      { title: "Small vases with garden roses and herbs", kind: "DIY", bucket: "Day of" },
      { title: "Baguettes in a linen-lined basket", kind: "DIY", bucket: "Day of" },
      { title: "Glass carafes of wine on the table", kind: "Buy", bucket: "Party week" },
      { title: "Chalkboard menu propped at one end", kind: "DIY", bucket: "1-2 weeks" },
