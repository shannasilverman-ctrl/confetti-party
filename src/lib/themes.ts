...
export const THEMES: Theme[] = [
  // ---------- BIRTHDAY ----------
  {
    ...
    decorIdeas: [
      {
        title: "Rainbow balloon arch over the entry",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 28,
      },
      {
        title: "Iridescent tablecloth on the main table",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 18,
      },
      {
        title: "DIY unicorn horn headbands for guests",
        kind: "DIY",
        bucket: "1-2 weeks",
        estPrice: 15,
      },
      ...
      {
        title: "Hang pastel streamers as a rainbow backdrop",
        kind: "DIY",
        bucket: "Day of",
        estPrice: 20,
      },
      {
        title: "Star-shaped fairy lights around the dessert table",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 22,
      },
      {
        title: "Sprinkle rainbow confetti down the table runner",
        kind: "Buy",
        bucket: "Day of",
        estPrice: 18,
      },
      {
        title: "Cotton candy in mini clouds for favors",
        kind: "Buy",
        bucket: "Party week",
        estPrice: 15,
      },
  ...
  },
  {
    ...
    decorIdeas: [
      {
        title: "Kraft paper table runner with dino footprints",
        kind: "DIY",
        bucket: "Party week",
        estPrice: 18,
      },
      {
        title: "Potted ferns and moss down the center",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 16,
      },
      {
        title: "Dino excavation dig kits as favors",
        kind: "Buy",
        bucket: "3-5 weeks",
        estPrice: 22,
      },
      {
        title: "Cave entrance made from a brown sheet at the door",
        kind: "DIY",
        bucket: "Party week",
        estPrice: 15,
      },
      {
        title: "Toy dinosaurs scattered across the table",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 22,
      },
      {
        title: "Volcano cupcake tower with red-orange frosting",
        kind: "DIY",
        bucket: "Day of",
        estPrice: 18,
      },
      ...
      {
        title: "Chalkboard 'Danger: Dino Zone' entry sign",
        kind: "DIY",
        bucket: "1-2 weeks",
        estPrice: 22,
      },
  ...
  },
  {
    ...
    decorIdeas: [
      {
        title: "Comic-book POW / ZAP paper cutouts on the walls",
        kind: "DIY",
        bucket: "1-2 weeks",
        estPrice: 10,
      },
      {
        title: "Red, blue, and yellow balloon column at the door",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 28,
      },
      ...
      {
        title: "City skyline silhouette on kraft paper backdrop",
        kind: "DIY",
        bucket: "1-2 weeks",
        estPrice: 20,
      },
      {
        title: "Superhero-logo cookies on the dessert table",
        kind: "Buy",
        bucket: "Party week",
        estPrice: 18,
      },
      {
        title: "'Training academy' obstacle course in the yard",
        kind: "DIY",
        bucket: "Day of",
        estPrice: 15,
      },
      ...
      {
        title: "Phone-booth photo prop by the entry",
        kind: "DIY",
        bucket: "1-2 weeks",
        estPrice: 22,
      },
  ...
  },
  {
    ...
    decorIdeas: [
      {
        title: "Blue crepe paper 'waves' along the table edge",
        kind: "DIY",
        bucket: "Party week",
        estPrice: 10,
      },
      ...
      {
        title: "Shells and starfish scattered as table confetti",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 12,
      },
      {
        title: "Hanging paper jellyfish above the food table",
        kind: "DIY",
        bucket: "1-2 weeks",
        estPrice: 10,
      },
      ...
      {
        title: "Ombre blue drinks with pineapple 'seaweed' garnish",
        kind: "DIY",
        bucket: "Day of",
        estPrice: 18,
      },
      {
        title: "Fishnet draped as a backdrop with paper fish",
        kind: "DIY",
        bucket: "1-2 weeks",
        estPrice: 20,
      },
  ...
  },
  {
    ...
    decorIdeas: [
      {
        title: "Mismatched vintage teacups from the thrift store",
        kind: "Buy",
        bucket: "3-5 weeks",
        estPrice: 14,
      },
      ...
      {
        title: "Tiered dessert stands with mini scones",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 18,
      },
      {
        title: "Lace tablecloth layered over linen",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 18,
      },
      {
        title: "Handwritten place cards on kraft tags",
        kind: "DIY",
        bucket: "Party week",
        estPrice: 10,
      },
      {
        title: "Floral crown-making station for guests",
        kind: "DIY",
        bucket: "1-2 weeks",
        estPrice: 15,
      },
      {
        title: "String lights woven through nearby branches",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 22,
      },
      {
        title: "Cucumber and berry infused water in glass pitchers",
        kind: "DIY",
        bucket: "Day of",
        estPrice: 18,
      },
  ...
  },
  {
    ...
    decorIdeas: [
      ...
      {
        title: "Glow-stick bracelets in a bowl at the door",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 15,
      },
      {
        title: "White table linens (they glow under UV)",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 18,
      },
      {
        title: "Neon paint splatter poster backdrop",
        kind: "DIY",
        bucket: "1-2 weeks",
        estPrice: 20,
      },
      {
        title: "Tonic-water drinks (they fluoresce)",
        kind: "Buy",
        bucket: "Party week",
        estPrice: 18,
      },
      {
        title: "Neon duct tape geometric shapes on the walls",
        kind: "DIY",
        bucket: "Party week",
        estPrice: 8,
      },
      {
        title: "White balloons with neon painted stripes",
        kind: "DIY",
        bucket: "Day of",
        estPrice: 12,
      },
      {
        title: "Highlighter pens for glow-in-the-dark signatures",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 15,
      },
  ...
  // ---------- BABY SHOWER ----------
  {
    ...
    decorIdeas: [
      ...
      {
        title: "Linen napkins tied with jute twine",
        kind: "DIY",
        bucket: "1-2 weeks",
        estPrice: 18,
      },
      ...
      {
        title: "Rattan pendant lights above the table",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 15,
      },
      {
        title: "Handwritten kraft-paper name cards",
        kind: "DIY",
        bucket: "Party week",
        estPrice: 10,
      },
  ...
  },
  {
    ...
    decorIdeas: [
      {
        title: "Navy tablecloth with gold star confetti",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 18,
      },
      {
        title: "Star-shaped fairy lights strung overhead",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 22,
      },
      ...
      {
        title: "'Twinkle twinkle little star' banner",
        kind: "Buy",
        bucket: "3-5 weeks",
        estPrice: 20,
      },
      {
        title: "Star-cutout sugar cookies as favors",
        kind: "Buy",
        bucket: "Party week",
        estPrice: 18,
      },
      {
        title: "Cloud-shaped cake with gold star topper",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 18,
      },
      ...
      {
        title: "Constellation printable place cards",
        kind: "DIY",
        bucket: "Party week",
        estPrice: 10,
      },
  ...
  },
  {
    ...
    decorIdeas: [
      ...
      {
        title: "Plush safari animals as centerpieces",
        kind: "Buy",
        bucket: "3-5 weeks",
        estPrice: 16,
      },
      ...
      {
        title: "Palm leaves down the table runner",
        kind: "Buy",
        bucket: "Party week",
        estPrice: 18,
      },
      ...
      {
        title: "Terracotta and orange balloon arch",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 28,
      },
      {
        title: "Safari cracker treat bags for favors",
        kind: "DIY",
        bucket: "Party week",
        estPrice: 18,
      },
  ...
  },
  {
    ...
    decorIdeas: [
      {
        title: "Bud vases in a line down the table",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 16,
      },
      {
        title: "Pastel balloon cloud in the corner",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 28,
      },
      ...
      {
        title: "Flower-shaped shortbread cookies",
        kind: "Buy",
        bucket: "Party week",
        estPrice: 18,
      },
      ...
      {
        title: "Small potted succulents as favors",
        kind: "Buy",
        bucket: "3-5 weeks",
        estPrice: 16,
      },
      {
        title: "White linen napkins with sprig of eucalyptus",
        kind: "DIY",
        bucket: "Day of",
        estPrice: 18,
      },
  ...
  // ---------- GRADUATION ----------
  {
    ...
    decorIdeas: [
      {
        title: "Black tablecloth with gold sequin runner",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 18,
      },
      {
        title: "Champagne flute display for a toast",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 18,
      },
      ...
      {
        title: "'Class of' foil banner over the mantel",
        kind: "Buy",
        bucket: "3-5 weeks",
        estPrice: 20,
      },
      {
        title: "Photo wall of grad from K through 12",
        kind: "DIY",
        bucket: "1-2 weeks",
        estPrice: 15,
      },
      ...
      {
        title: "Diploma-shaped cookies as favors",
        kind: "Buy",
        bucket: "Party week",
        estPrice: 18,
      },
      {
        title: "LED marquee letters spelling grad's initials",
        kind: "Buy",
        bucket: "3-5 weeks",
        estPrice: 45,
      },
  ...
  },
  {
    ...
    decorIdeas: [
      {
        title: "Papel picado banners strung across the yard",
        kind: "Buy",
        bucket: "3-5 weeks",
        estPrice: 20,
      },
      {
        title: "Cactus centerpieces in terracotta pots",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 16,
      },
      {
        title: "Colorful woven blanket as tablecloth",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 18,
      },
      {
        title: "Margarita bar with fresh limes on display",
        kind: "DIY",
        bucket: "Day of",
        estPrice: 18,
      },
      {
        title: "Marigold blooms scattered along the runner",
        kind: "Buy",
        bucket: "Party week",
        estPrice: 18,
      },
      {
        title: "String lights zig-zagged overhead",
        kind: "Buy",
        bucket: "3-5 weeks",
        estPrice: 22,
      },
      ...
      {
        title: "Mini piñata favors at each place setting",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 20,
      },
  ...
  },
  {
    ...
    decorIdeas: [
      {
        title: "Blown-up yearbook photos on the wall",
        kind: "DIY",
        bucket: "1-2 weeks",
        estPrice: 15,
      },
      {
        title: "Vintage lockers or trophies as props",
        kind: "DIY",
        bucket: "3-5 weeks",
        estPrice: 22,
      },
      {
        title: "Cream and cherry-red balloon garland",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 28,
      },
      {
        title: "Notebook-paper printed table runner",
        kind: "DIY",
        bucket: "1-2 weeks",
        estPrice: 18,
      },
      {
        title: "'Sign my yearbook' guest book on the entry table",
        kind: "DIY",
        bucket: "1-2 weeks",
        estPrice: 10,
      },
      {
        title: "'90s hits playlist on a boombox prop",
        kind: "Buy",
        bucket: "3-5 weeks",
        estPrice: 32,
      },
      ...
      {
        title: "Polaroid camera and film for guest snapshots",
        kind: "Buy",
        bucket: "3-5 weeks",
        estPrice: 40,
      },
  ...
  // ---------- HOLIDAY ----------
  {
    ...
    decorIdeas: [
      ...
      {
        title: "Crystal ornaments as place-setting accents",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 15,
      },
      {
        title: "White paper snowflakes hanging from the ceiling",
        kind: "DIY",
        bucket: "1-2 weeks",
        estPrice: 15,
      },
      {
        title: "Bare branches spray-painted white in tall vases",
        kind: "DIY",
        bucket: "3-5 weeks",
        estPrice: 16,
      },
      {
        title: "Silver taper candles down the center",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 14,
      },
      {
        title: "Snowflake-etched drinking glasses",
        kind: "Buy",
        bucket: "3-5 weeks",
        estPrice: 14,
      },
      {
        title: "Icy blue string lights along the mantel",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 22,
      },
      {
        title: "White chocolate 'snowball' truffles as favors",
        kind: "Buy",
        bucket: "Party week",
        estPrice: 18,
      },
  ...
  },
  {
    ...
    decorIdeas: [
      {
        title: "Red-and-black buffalo plaid tablecloth",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 18,
      },
      {
        title: "Pinecones and evergreen sprigs along the runner",
        kind: "DIY",
        bucket: "Party week",
        estPrice: 18,
      },
      ...
      {
        title: "Hot cocoa bar with marshmallows and syrups",
        kind: "DIY",
        bucket: "Day of",
        estPrice: 18,
      },
      {
        title: "Wool blankets draped over every chair",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 18,
      },
      {
        title: "Lanterns with pillar candles on the porch",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 22,
      },
      ...
      {
        title: "Cinnamon-stick bundle napkin ties",
        kind: "DIY",
        bucket: "Party week",
        estPrice: 15,
      },
  ...
  },
  {
    ...
    decorIdeas: [
      ...
      {
        title: "Small disco balls as centerpieces",
        kind: "Buy",
        bucket: "3-5 weeks",
        estPrice: 45,
      },
      ...
      {
        title: "Blush balloon and gold star garland",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 12,
      },
      ...
      {
        title: "'Cheers' foil banner over the bar",
        kind: "Buy",
        bucket: "3-5 weeks",
        estPrice: 20,
      },
      {
        title: "Fringe curtain backdrop in gold Mylar",
        kind: "Buy",
        bucket: "3-5 weeks",
        estPrice: 20,
      },
  ...
  // ---------- DINNER PARTY ----------
  {
    ...
    decorIdeas: [
      {
        title: "Terracotta serving platters family-style",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 15,
      },
      ...
      {
        title: "Linen tablecloth in unbleached cream",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 18,
      },
      ...
      {
        title: "Rustic bread board with focaccia at the center",
        kind: "DIY",
        bucket: "Day of",
        estPrice: 18,
      },
      {
        title: "Handwritten menu cards on kraft paper",
        kind: "DIY",
        bucket: "Party week",
        estPrice: 10,
      },
      {
        title: "Fresh rosemary sprigs at each place setting",
        kind: "DIY",
        bucket: "Day of",
        estPrice: 16,
      },
  ...
  },
  {
    ...
    decorIdeas: [
      ...
      {
        title: "Brass taper candlesticks at varied heights",
        kind: "Buy",
        bucket: "3-5 weeks",
        estPrice: 14,
      },
      ...
      {
        title: "Single-stem dark florals in small vessels",
        kind: "Buy",
        bucket: "Party week",
        estPrice: 16,
      },
      ...
      {
        title: "Linen napkins tied with brass rings",
        kind: "DIY",
        bucket: "1-2 weeks",
        estPrice: 18,
      },
      {
        title: "Dim the overheads to 20%, candles do the work",
        kind: "DIY",
        bucket: "Day of",
        estPrice: 0,
      },
      {
        title: "Cocktail menu printed on black card stock",
        kind: "DIY",
        bucket: "Party week",
        estPrice: 15,
      },
  ...
  },
  {
    ...
    decorIdeas: [
      {
        title: "Crisp white tablecloth over the table",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 18,
      },
      ...
      {
        title: "Small vases with garden roses and herbs",
        kind: "DIY",
        bucket: "Day of",
        estPrice: 16,
      },
      ...
      {
        title: "Glass carafes of wine on the table",
        kind: "Buy",
        bucket: "Party week",
        estPrice: 18,
      },
      {
        title: "Chalkboard menu propped at one end",
        kind: "DIY",
        bucket: "1-2 weeks",
        estPrice: 22,
      },
      {
        title: "Fresh potted herbs as centerpieces",
        kind: "Buy",
        bucket: "1-2 weeks",
        estPrice: 16,
      },
