    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-6 py-6 pb-24">
        ...
        <section className="prose prose-slate mt-8 max-w-none text-secondary">
          ...
          <p className="mt-3 text-sm">
            You own the party data you enter. Confetti stores it so you can plan across sessions
            and so guests with your invite link can respond. Do not enter sensitive personal
            information about others without their consent (health records, financial data,
            government IDs).
          </p>
          ...
          <p className="mt-3 text-sm">
            The voice co-host and text suggestions are provided as a convenience. They may make
            mistakes. Review any generated plan before you rely on it. Do not share confidential
            information you would not want processed by our AI subprocessor.
          </p>

          <h2 className="mt-8 font-display text-xl font-semibold">Availability and warranty</h2>
          <p className="mt-3 text-sm">
            Confetti is provided "as is" without warranty. We aim for high availability but do not
            guarantee uninterrupted service. The operator is not liable for lost data, missed
            events, or any indirect damages arising from use of the service.
          </p>

          <h2 className="mt-8 font-display text-xl font-semibold">Termination</h2>
          <p className="mt-3 text-sm">
            You can delete your parties or account at any time. The operator may suspend accounts
